...
class DecisionVariables:
    def __init__(self, g: Grammar, min_n: int, max_n: int, max_depth: int):
        ...
        self.topdown_rule        = intvar(0,  max_depth+1,           shape=(max_n-1, g.NUMBER_OF_RULES), name="TopDownOrdered")
        self.leftright_rule      = intvar(0,  max_n+1,               shape=g.NUMBER_OF_RULES,            name="LeftRightOrdered")
